...
import {InputDetail, OutputDetail} from "@kit-iai-proof/proof-config-manager-client";
                            ...
                            >
                                ...
                                >
                                    <Handle
                                        ...
                                        style={{backgroundColor: getTypeColor(handle.type, palette), border: getTypeBorder(handle.type, palette)}}
                                    >
                                    </Handle>
                                </Tooltip>
                                <Typography
